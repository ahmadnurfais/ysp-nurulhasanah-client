...
?>
<div class="row">
	<div class="<?php risehand_column_for_events(); ?>">
<div id="tribe-events-content" class="tribe-events-single">

	<p class="tribe-events-back">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'All %s', '%s Events plural label', 'risehand' ), $events_label_plural ); ?></a>
	</p> 
	<!-- Notices -->
	...
	<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
		<!-- Navigation -->
		<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'risehand' ), $events_label_singular ); ?>">
...
<aside id="secondary" class="widget-area  all_side_bar  col-lg-4 col-md-12 col-sm-12">		
	<div class="events_siderbar side_bar_default_class">
