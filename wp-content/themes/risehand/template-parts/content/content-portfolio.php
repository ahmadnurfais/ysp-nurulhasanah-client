 ...
 */ 
$share_disable =   get_risehand_option('portfolio_share_disable'); 
$next_prev_enable =  get_risehand_option('portfolio_next_prev_enable'); 
$feature_image_enable =   get_risehand_option('portfolio_feature_image_enable'); 
$relatedpost_enable =   get_risehand_option('portfolio_relatedpost_enable'); 
$comment_class = "";
if (comments_open()){
