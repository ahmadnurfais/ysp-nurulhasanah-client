...
add_action( 'widgets_init', function(){
	register_widget( 'risehand_popular_causes' );
});
class risehand_popular_causes extends \WP_Widget {
 
	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'risehand_widget_donation_entries',
			'description'                 => __( 'Your most recent Posts.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'donation-posts', __( 'Risehand - Popular Donation Posts' ), $widget_ops );
		$this->alt_option_name = 'risehand_widget_donation_entries';
	}
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Popular Causes' );
		...
		$r = new WP_Query( apply_filters( 'widget_posts_args', array(
            ...
            'no_found_rows'       => true,
            'post_type'           => 'give_forms', // GiveWP causes have post type 'give_forms'
            'post_status'         => 'publish',
