...
class Slider_v3 extends \Elementor\Widget_Base{
        public function get_name()
        {
            return 'risehand-slider-3';
        }

        public function get_title()
        {
            return __('Slider V3', 'risehand-addons');
        }
        ...
        $this->start_controls_section('slider_v3_settings',
        [ 
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3::before' => 'background: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_control(
        ...
        [
            ...
            'size_units' => [ 'px', '%', 'em' ],
            'selectors' => [
                '{{WRAPPER}}  .slider_box_V3 ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
            ],
        ]
    );
    $this->add_responsive_control(
        ...
        [
            ...
            'default'    => 800, 
            'selectors' => [
                '{{WRAPPER}}  .slider_box_V3 ' => 'height: {{VALUE}}px!important;',
            ],
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'size_units' => [ 'px', '%', 'em' ],
            'selectors' => [
                '{{WRAPPER}}  .slider_box_V3 .slider_content ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
            ],
        ]
    );
    $this->add_control(
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .smtitle i   ' => 'color: {{VALUE}};',
                '{{WRAPPER}}  .slider_box_V3 .smtitle svg path ' => 'fill: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'smtypo',
            'selector' => '{{WRAPPER}} .slider_box_V3 .smtitle .intitle ',
        ]
    );
    $this->add_control(
        'small_title_color',
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .smtitle .intitle' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'titypo',
            'selector' => '{{WRAPPER}} .slider_box_V3 .title ',
        ]
    );
    $this->add_control(
        'title_color',
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .title ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'descypo',
            'selector' => '{{WRAPPER}} .slider_box_V3 .content ',
        ]
    );
    $this->add_control(
        'desc_color',
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .content ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_group_control(
        ...
        [
            ...
            'name' => 'btntypo',
            'selector' => '{{WRAPPER}} .slider_box_V3 .theme_btn ',
        ]
    );
    $this->add_control(
        'button_icon_color',
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one .icon i  , {{WRAPPER}} .slider_box_V3 .theme_btn.one .icon span ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one ' => 'border-color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one ' => 'background: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one:hover .icon i , {{WRAPPER}} .slider_box_V3 .theme_btn.one:hover .icon span ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one:hover ' => 'color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one:hover ' => 'border-color: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .theme_btn.one:hover ' => 'background: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    $this->add_group_control(
        \Elementor\Group_Control_Typography::get_type(),
        [
            'label' => esc_html__( 'Video Button Tex Typography', 'risehand-addons' ),
            'name' => 'btn2typo',
            'selector' => '{{WRAPPER}} .video_box_two .text ',
        ]
    );
    $this->add_control(
        'button_color_br',
    ...
    $this->add_control(
        'patternone',
        [
            'label' => esc_html__( 'Pattern Color 1', 'risehand-addons' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .line_image_1 ' => 'background: {{VALUE}};',
            ],
            'condition' => [
                'pattern_enables' => 'yes',
            ],
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}}  .slider_box_V3 .line_image_2 ' => 'background: {{VALUE}};',
            ],
            'condition' => [
                'pattern_enables' => 'yes',
            ],
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_box_V3 .hand_image_0 ' => 'background: {{VALUE}};',
            ],
            'condition' => [
                'pattern_enables' => 'yes',
            ],
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'step'    => 1, 
            'selectors' => [
                '{{WRAPPER}}  .slider_v3 .slider-pagination' => 'top: {{VALUE}}px!important;',
            ],
        ]
    ); 
    $this->add_control(
    ...
    $this->add_control(
        'nav1color',
        [
            'label' => esc_html__( 'Prev /  Next Arow Background Color', 'risehand-addons' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slider_v3 .swiper_arrows .arrow-prev , {{WRAPPER}} .slider_v3 .swiper_arrows .arrow-next' => 'background: {{VALUE}};',
            ], 
        ]
    ); 
    $this->add_control(
    ...
    ?>  
    <section class="slider_v3"> <div class="swiper swiper-container swiper_container loading" data-swiper='{ "loop": false, "autoplay": { "delay": "<?php echo esc_attr($settings['duration']); ?>" }, "speed": "<?php echo esc_attr($settings['speed']); ?>", "centeredSlides": false, "parallax" : true, "spaceBetween": 0, "navigation": { "nextEl": ".slider-button-next", "prevEl": ".slider-button-prev" }, "pagination": { "el": ".slider-pagination", "clickable": true , "type": "bullets" }, "grabCursor": true, "breakpoints": { "1200": { "slidesPerView": 1 }, "1024": { "slidesPerView": 1 }, "768": { "slidesPerView": 1 }, "576": { "slidesPerView": 1 } } }'> <div class="swiper-wrapper"> <?php if(!empty($settings['slider_repeater_three'])): foreach($settings['slider_repeater_three'] as $key => $sliderrepeater): $slider_content_image = ''; $alt_slider_content_image = ''; if (!empty($sliderrepeater['slider_content_image']['url'])) { $slider_content_image = $sliderrepeater['slider_content_image']['url']; $alt_slider_content_image = $sliderrepeater['slider_content_image']['alt']; $alt_slider_content_image = !empty($alt_slider_content_image) ? $alt_slider_content_image : 'slider-image-one'; } ?> <div class="swiper-slide"> <div class="slider_box_V3 <?php if(!empty($sliderrepeater['image_enable'])): ?> image_enable<?php endif; ?> slideralignment_<?php echo esc_attr($sliderrepeater['slideralignment']); ?>"> <?php if(!empty($sliderrepeater['slider_image']['url'])): $slider_images = $sliderrepeater['slider_image']['url']; $alt_slider = $sliderrepeater['slider_image']['alt']; if(!empty($alt_slider)){ $alt_slider = $alt_slider; }else{ $alt_slider = 'slider-image'; } ?> <div class="slide-bgimg" style="background-image:url(<?php echo esc_url($slider_images); ?>);" data-swiper-parallax-x="<?php echo esc_attr($settings['slider_parallax']); ?>%"> </div> <?php endif; ?> <?php if($settings['pattern_enables'] == true): ?> <div class="hand_image_0 mask_image" style="mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/shape-4.png' ?>); -webkit-mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/shape-4.png' ?>);"> </div> <div class="line_image_2 mask_image" style="mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/line-1.png' ?>); -webkit-mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/line-1.png' ?>);"> </div> <div class="line_image_1 mask_image" style="mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/shape-1.png' ?>); -webkit-mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/shape-1.png' ?>);"> </div> <?php endif; ?> <div class="<?php echo esc_attr($settings['slider_layout']); ?>"> <div class="row"> <?php if($sliderrepeater['slideralignment'] == 'right'): ?> <div class="col-lg-6 col-md-12 col-sm-12"> <?php if(!empty($sliderrepeater['image_enable'])): ?> <div class="position-relative"> <?php if($settings['pattern_enables'] == true): ?> <div class="mask_iamge" style="mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/mask-1.png' ?>); -webkit-mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/mask-1.png' ?>);" data-swiper-parallax-y="600"> </div> <?php endif; ?> <div class="slider_image"> <img src="<?php echo esc_url($slider_content_image); ?>" class="img-fluid " alt="<?php echo esc_attr($alt_slider_content_image); ?>" data-swiper-parallax-x="-160%" data-swiper-parallax-opacity="0" /> </div> </div> <?php endif; ?> </div> <?php endif; ?> <div class="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center height_equal"> <div class="slider_content"> <?php if(!empty($sliderrepeater['small_title'])): ?> <div class="smtitle d-flex align-items-center" data-swiper-parallax-x="30%" data-swiper-parallax-opacity="0"> <?php if($sliderrepeater['icontype'] == 'fontawesome'): ?> <?php if(!empty($sliderrepeater['icon_fontawesome'])): ?> <div class="icon"> <?php \Elementor\Icons_Manager::render_icon($sliderrepeater['icon_fontawesome'], [ 'aria-hidden' => 'false' ]); ?> </div> <?php endif; ?> <?php // none end ?> <?php elseif($sliderrepeater['icontype'] == 'none'): ?> <?php // none end ?> <?php else: ?> <?php if(!empty($sliderrepeater['icon_fonts'])): ?> <div class="icon"> <i class="<?php echo esc_attr($sliderrepeater['icon_fonts']); ?>"></i> </div> <?php endif; ?> <?php endif; ?> <div class="intitle"> <?php echo wp_kses($sliderrepeater['small_title'] , $allowed_tags); ?> </div> </div> <?php endif; ?> <?php if(!empty($sliderrepeater['title'])): ?> <div class="title color_dark" data-swiper-parallax-x="-50%" data-swiper-parallax-opacity="0"> <?php echo wp_kses($sliderrepeater['title'] , $allowed_tags); ?> </div> <?php endif; ?> <?php if(!empty($sliderrepeater['content'])): ?> <p class="content" data-swiper-parallax-x="-70%" data-swiper-parallax-opacity="0"> <?php echo wp_kses($sliderrepeater['content'] , $allowed_tags); ?> </p> <?php endif; ?> <div class="d-flex align-items-center button_group" data-swiper-parallax-y="100"> <?php if(!empty($sliderrepeater['button_one'])): $buttonlinkone = '#'; $btntargetone = ''; $btnnofollowone = ''; if (!empty( $sliderrepeater['button_1_link']['url'])) { $btntargetone = $sliderrepeater['button_1_link']['is_external'] ? ' target="_blank"' : ''; $btnnofollowone = $sliderrepeater['button_1_link']['nofollow'] ? ' rel="nofollow"' : ''; } ?> <a class="theme_btn one" href="<?php echo esc_url($sliderrepeater['button_1_link']['url']);?>" <?php echo esc_attr($btntargetone); ?> <?php echo esc_attr($btnnofollowone); ?> data-swiper-parallax-y="100"> <span> <?php echo esc_html($sliderrepeater['button_one']);?> </span> <?php if($sliderrepeater['button_icontypeone'] == 'fontawesome'): ?> <?php if(!empty($sliderrepeater['button_iconfontawe'])): ?> <div class="icon"> <?php \Elementor\Icons_Manager::render_icon($sliderrepeater['button_iconfontawe'], [ 'aria-hidden' => 'false' ]); ?> </div> <?php endif; ?> <?php // none end ?> <?php elseif($sliderrepeater['button_icontypeone'] == 'none'): ?> <?php // none end ?> <?php else: ?> <?php if(!empty($sliderrepeater['button_icontype'])): ?> <div class="icon"> <i class="<?php echo esc_attr($sliderrepeater['button_icontype']); ?>"></i> </div> <?php endif; ?> <?php endif; ?> </a> <?php endif; ?> <div class="video_box_two"> <?php $video_link = !empty($sliderrepeater['video_link']) ? $sliderrepeater['video_link'] : ''; $video_text = !empty($sliderrepeater['video_text']) ? $sliderrepeater['video_text'] : ''; ?> <a href="<?php echo esc_url($video_link); ?>" class="lightbox-image"> <div class="icon zoomInOut"> <i class="risehand-play1"></i> </div> <div class="text title_no_a_16"> <?php echo esc_attr($video_text); ?> </div> </a> </div> </div> </div> </div> <?php if($sliderrepeater['slideralignment'] == 'left'): ?> <div class="col-lg-6 col-md-12 col-sm-12"> <?php if(!empty($sliderrepeater['image_enable'])): ?> <div class="position-relative"> <?php if($settings['pattern_enables'] == true): ?> <div class="mask_iamge" style="mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/mask-1.png' ?>); -webkit-mask-image: url(<?php echo RISEHAND_ADDONS_URL . 'assets/image/slider-2/mask-1.png' ?>);" data-swiper-parallax-y="600"> </div> <?php endif; ?> <div class="slider_image"> <img src="<?php echo esc_url($slider_content_image); ?>" class="img-fluid " alt="<?php echo esc_attr($alt_slider_content_image); ?>" data-swiper-parallax-x="-160%" data-swiper-parallax-opacity="0" /> </div> </div> <?php endif; ?> </div> <?php endif; ?> </div> </div> </div> </div> <?php endforeach; ?> <?php endif; ?> </div> <div class="swiper_arrows"> <div class="slider-button-prev arrow-prev"></div> <div class="slider-button-next arrow-next"></div> </div> <div class="slider-pagination"></div> </div> </section> 
<?php
    }
}
