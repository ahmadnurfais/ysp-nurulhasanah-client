 ...
 ** ==============================
 */
add_action('risehand_get_welcome' , 'risehand_welcome');
function risehand_welcome(){
global $wpdb;
?>
<section class="risehand_tab_box">
    <div class="risehand_tab_wrapper">
        <div class="risehand_admin_tab">
            <div class="risehand_content_box"> 
                <div class="welcome_contnet c_bg_color">
                    ...
                    <p class="end">
                        <?php echo esc_html(
                            'Thank you for purchasing our risehand theme. Here you are able to 
                            ...
                            <div class="inform">
                                <ul>
                                    ...
                                    <?php   
                                        ...
                                        $mysql_version = $wpdb->get_var($sql); 
                                        if ($mysql_version !== null) {
                                            echo '<span>' . esc_html($mysql_version) . '</span>';
                                        } else {
                                            echo '<span>' . esc_html__('MySQL version not available.', 'risehand') . '</span>';
                                        }
                                    ?> 
                                    </li>
                                </ul>
                        ...
                        <div class="right_box">
                            <div class="d-flex">
                                <div class="documentation common_box">
                                    ...
                                    <div>  <h6><?php echo esc_html__(
                                        ...
                                        "risehand"
                                            ...
                                            <a href="https://themepanthers.com/documentation/risehand-documentation/"
                                                target="_blank">
                                                <?php echo esc_html(
                                                    "Documentation",
                                                    "risehand"
                                ...
                                <div class="support common_box">
                                    <div class="inner_docsuppo">
                                        <div><h6> <?php echo esc_html__(
                                            "risehand theme comes with 6 months of free support for every license you purchase. Support can be extended through subscriptions via ThemeForest.",
                                            "risehand"
                                        ); ?>
